...
import { IP_GetGameDept, IP_InsertDeptGame } from '@/api/issueSystem/channelSys.js'
...
export default{
    ...
    methods:{
        ...
        async getDeptList(){
            ...
            let selected = await IP_GetGameDept({snKey: this.rowData.snKey});
            let array;
            if(selected.data){
